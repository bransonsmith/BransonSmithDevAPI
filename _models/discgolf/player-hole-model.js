...
const all_fields = [
    ...
    { name: 'playerroundid', type: 'varchar(255)', attributes: 'NOT NULL',             mustHaveExistingObject: true,  table: 'discgolfplayerrounds', onDto: true,  createField: true ,  updateField: true , optional: false },
